...
describe "User pages" do
  ...
  describe "profile page" do
    ...
    describe "unfollowing a user" do
      ...
      it "should describe the followed user count" do
        expect do
          click_button "Unfollow"
       end.to change(user.followed_users, :count).by(-1)
     end

     it "should describe the other user's followers count" do
      expect do
        click_button "Unfollow"
        end.to change(other_user.followers, :count).by(-1)
      end
   ...
   describe "edit" do
    ...
    before do
      ...
      describe "page" do
        ...
        it { should have_link('change', href:'http://gravatar.com/yeyong14')}
      end
